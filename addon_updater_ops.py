...
class AddonUpdaterInstallPopup(bpy.types.Operator):
    ...
    ignore_enum = bpy.props.EnumProperty(
        ...
        items=[("install", "Update Now", "Install update now"),
               ("ignore", "Ignore",
...
class AddonUpdaterUpdateNow(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if updater.update_ready:
            ...
            self.report({'ERROR'},
                        "Encountered a problem while trying to update")
            return {'CANCELLED'}
...
class AddonUpdaterInstallManually(bpy.types.Operator):
    ...
    error = bpy.props.StringProperty(name="Error Occurred",
                                     default="",
                                     options={'HIDDEN'})
...
def register(bl_info):
    ...
    updater.website = "https://github.com/SmittyWerbenJJ/HaydeeTools"
