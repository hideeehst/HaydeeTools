...
def register():
    ...
    bpy.utils.register_class(HaydeeToolsImportPanel)
    bpy.utils.register_class(HaydeeToolsExportPanel)
    bpy.utils.register_class(HaydeeToolsSkelPanel)


def unregister():
    """Unregister addon classes."""
    bpy.utils.unregister_class(HaydeeToolsImportPanel)
    bpy.utils.unregister_class(HaydeeToolsExportPanel)
    bpy.utils.unregister_class(HaydeeToolsSkelPanel)
